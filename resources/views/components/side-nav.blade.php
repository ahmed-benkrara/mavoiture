...
<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        ...
        <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/cars">
                <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                    <svg width="12px" height="12px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>car</title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                <g transform="translate(1716.000000, 291.000000)">
                                    <g transform="translate(453.000000, 454.000000)">
                                        <path class="fill-slate-800 opacity-60" d="M33.5,18.9 C33.5,18.9 36,21.5 36,23.5 C36,25.5 34.2,27.4 33.5,27.7 C32.8,28 31,28.2 29.5,27.7 C28,27.2 26.5,25.8 24.5,24.2 C23,23.1 18,21.7 16,21.7 C14,21.7 12,23.1 10.5,24.2 C8.5,25.8 7,27.2 5.5,27.7 C4,28.2 2.2,28 1.5,27.7 C0.8,27.4 3,25.5 3,23.5 C3,21.5 5.5,18.9 5.5,18.9 C5.5,18.9 1,18 1,16.5 C1,15 2.5,15 2.5,15 C2.5,15 4.7,13.3 5.5,13 C6.3,12.7 7.5,13 7.5,13 C7.5,13 11,11.3 16,11.3 C21,11.3 24.5,13 24.5,13 C24.5,13 25.7,12.7 26.5,13 C27.3,13.3 29.5,15 29.5,15 C29.5,15 31,15 31,16.5 C31,18 26.5,18.9 26.5,18.9 C26.5,18.9 22,20.3 20,21.7 C18,23.1 13,21.7 11.5,24.2 C9.5,25.8 8,27.2 6.5,27.7 C5,28.2 3.2,28 2.5,27.7 C1.8,27.4 4,25.5 4,23.5 C4,21.5 6.5,18.9 6.5,18.9 C6.5,18.9 1.5,17.6 1.5,16.5 C1.5,15.4 4,15.5 4,15.5 C4,15.5 7.5,13.7 7.5,13.5 C7.5,13.3 12,12 16,12 C20,12 24.5,13.5 24.5,13.5 C24.5,13.5 28,15.5 31,15.5 C34,15.5 36,16.5 36,16.5 C36,16.5 33.5,18.9 33.5,18.9 Z"></path>
                                        <path class="fill-slate-800" d="M8,27 C6.9,27 6,26.1 6,25 C6,23.9 6.9,23 8,23 C9.1,23 10,23.9 10,25 C10,26.1 9.1,27 8,27 Z M28,27 C26.9,27 26,26.1 26,25 C26,23.9 26.9,23 28,23 C29.1,23 30,23.9 30,25 C30,26.1 29.1,27 28,27 Z M35,10 L34,7 L32,7 L31,10 L27,10 L23,2 L13,2 L9,10 L5,10 L2,26 L0,28 L0,32 L36,32 L36,28 L34,26 L34,23 L35,10 Z M4.5,28 C4.224,28 4,28.224 4,28.5 C4,28.776 4.224,29 4.5,29 C4.776,29 5,28.776 5,28.5 C5,28.224 4.776,28 4.5,28 Z M31.5,28 C31.224,28 31,28.224 31,28.5 C31,28.776 31.224,29 31.5,29 C31.776,29 32,28.776 32,28.5 C32,28.224 31.776,28 31.5,28 Z M35,15 L3,15 L7,10 L9,3 L27,3 L29,10 L33,15 L35,15 Z"></path>
                                    </g>
                                </g>
                            </g>
                        </g>
